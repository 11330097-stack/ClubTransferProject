...
urlpatterns = [
    ...
    path('admin-panel/unassigned/students/', views.UnassignedStudentListView.as_view(), name='unassigned_student_list'),
    path('admin-panel/unassigned/teachers/', views.UnassignedTeacherListView.as_view(), name='unassigned_teacher_list'),
